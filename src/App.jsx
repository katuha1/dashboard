...
const teams = [
  { id: 1, name: 'Екатерина', href: '#', initial: 'Е', current: false },
  { id: 2, name: 'Авдосий', href: '#', initial: 'А', current: false },
  { id: 3, name: 'Людмила', href: '#', initial: 'Л', current: false },
]
            ...
            <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
              ...
              <div className="flex items-center gap-x-4 lg:gap-x-6">
                <button type="button" className="-m-2.5 p-2.5 text-gray-400 hover:text-gray-500">
                  ...
                  <img src="public/plus.png" alt="" className="plus" aria-hidden="true" />
                </button>
                  ...
                  <div className="relative flex items-start pb-4 pt-3.5">
                    <div className='cart'>
                      <div className="min-w-0 flex-1 text-sm leading-6">
                        ...
                        <img src="./public/trash" alt="" />
                      </div>

                      <div className="ml-3 flex h-6 items-center">
                        <button><img className='trash' src="./public/trash.png" alt="" /></button>
                        <button><img className='comm' src="./public/comment.png" alt="" /></button>
                      </div>
                    </div>
                  </div>
                  <div className="relative flex items-start pb-4 pt-3.5">
